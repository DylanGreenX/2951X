        ...
        *,
        ...
        payload: dict[str, Any] = {
            ...
            "config": {
                ...
                "NPC_SLM_MODEL_ID": getattr(config, "NPC_SLM_MODEL_ID", None),
                "NPC_SLM_DEVICE": getattr(config, "NPC_SLM_DEVICE", None),
                "NPC_SLM_DTYPE": getattr(config, "NPC_SLM_DTYPE", None),
                "NPC_SLM_MAX_NEW_TOKENS": getattr(config, "NPC_SLM_MAX_NEW_TOKENS", None),
                "NPC_SLM_DO_SAMPLE": getattr(config, "NPC_SLM_DO_SAMPLE", None),
                "NPC_SLM_TEMPERATURE": getattr(config, "NPC_SLM_TEMPERATURE", None),
                "NPC_SLM_TOP_P": getattr(config, "NPC_SLM_TOP_P", None),
                "NPC_SLM_ENABLE_TOOL_CALLS": getattr(config, "NPC_SLM_ENABLE_TOOL_CALLS", None),
                "NPC_SLM_MAX_TOOL_TURNS": getattr(config, "NPC_SLM_MAX_TOOL_TURNS", None),
